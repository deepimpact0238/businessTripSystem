...
<html>
    ...
    <body>
		...
		<div class="container">
			<form method="POST" action="{{ route('contact.update', ['id' => $contact->id])}}" class="row" id = "shinsei_form" onsubmit="return submitCheck()">
			@csrf
				<div class="col-sm-8 col-sm-offset-2">
					...
					<button type="submit" class="btn btn-primary" onsubmit="return submitCheck()" >更新する</button>
